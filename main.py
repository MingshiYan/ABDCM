...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='model_front_door', help='')
    parser.add_argument('--data_loader', type=str, default='data_set_single', help='')
    ...
    elif args.data_name == 'ijcai_cold':
        args.data_path = '../data/IJCAI_cold_1000'
        if args.behaviors is None:
            args.behaviors = ['click', 'fav', 'cart', 'buy']
    else:
    ...
    model = getattr(modules, 'CBPA')(args, dataset).to(args.device)
